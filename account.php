...
var countdownTimer = setInterval('secondPassed()', 1000);
          ...
          if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2) {
            ...
            <!-- countdown timer new -->
            <?php
            // getting time limit from database
            ...
            // set tim remaining to second
            $time_remaining = $_SESSION['expire'] - time();
            ?>
            <span style="float: right;" id="countdown">
            </span>
            <!-- send the eid to javascript, while time passed page will rirecting to result page with current eid -->
            <input type="hidden" id="eid" value="<?= @$_GET['eid'] ?>">
            <!-- send the time remaining to js, automatically refresh display time with javascript -->
            <input type="hidden" id="tl" value="<?= $time_remaining; ?>">
