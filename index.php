        ...
        <form class="form-horizontal" name="form" action="sign.php?q=account.php" onSubmit="return validateForm()" method="POST">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="mob" name="mob" onkeyup="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')" placeholder="Enter your mobile number" class="form-control input-md" type="number">
